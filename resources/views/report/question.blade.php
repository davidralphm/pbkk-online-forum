...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset("css/reportQuestion.css") }} ">
</head>
<body>
    @if ($errors->any())
    ...
    <div class="bjir">
        <div class="woy">
            ...
            <form action="/question/report/{{ $question->id }}" method="post" style="width: 100%">
                {{ csrf_field() }}
                ...
                <input type="submit" value="Report Question" class="btn btn-outline-secondary">
            </form>
        </div>
    </div>
